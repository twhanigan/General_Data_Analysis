...
OXA1L = ['OXA1L']
Cyto = ['NQO1','SLC16A3','KDELR1']
ComplexIV = ['MT-CO1','MT-CO2','MT-CO3','COX5B','COX5A','COX6C','COX7C','MT-CYB','COX6B1','COX7A2','PET100'] #'OXA1L',
...
colors = ['lightcoral','tomato','red','crimson','darkred','k',]
newpos = pos[0::1]
...
#label = ['Complex I','Complex II','Complex III','Complex IV','Complex V','Other']

#label = ['CI','CII','CIII','CIV','CV','Mito','Cyto']

leg = plt.legend(handle,label, handlelength=0, handletextpad=0,bbox_to_anchor=(5, 1, 1, 1), loc='upper right',borderaxespad=0.,ncol=3,columnspacing=0.5,)
#label = ['Complex I','Complex II','Complex III','Complex IV','Complex V','CIV Insertase','Mitochondrial','Cytosolic']

i=-1
for text in leg.get_texts():
    i+=1
    text.set_color(colors[i])
plt.savefig('HeatMap_PVP_HitsOnly_Legend_010325_N.png',dpi=600,transparent=True,bbox_inches='tight',pad_inches=2)
plt.show()